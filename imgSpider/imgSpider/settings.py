...
DOWNLOADER_MIDDLEWARES = {
    'imgSpider.middlewares.CustomRetryPauseMiddleware': 544,  # 设置为比HttpProxyMiddleware优先级高的值
    'scrapy.downloadermiddlewares.httpproxy.HttpProxyMiddleware': 555,  # 设置为比RetryMiddleware优先级低的值
    # 其他中间件...
}
